              ...
              <Link to="/" className="flex items-center space-x-3 group">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-xl text-slate-900 leading-tight">
                    {t('नागरिक आवाज', 'Nagarik Aawaz')}
                  </span>
                  <span className="text-xs text-[#0094da] font-bold uppercase tracking-wider font-english">
                    Civic Tech
                  </span>
                </div>
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4 flex items-center">
              <FaUserShield className="h-5 w-5 mr-3 text-[#0094da]" /> {t('नागरिक आवाज', 'Nagarik Aawaz')}
            </h3>
